...
export default function CheckInPage() {
  ...
  function handleManualCheck() {
    ...
    /*
      PLACEHOLDER FOR REAL MANUAL CHECK-IN

      Later connect this to the same /api/checkin endpoint.
    */
        ...
        >
          ...
          >
            ...
            <div
              ...
              "
            >
              {/* Real html5-qrcode scanner can mount here later */}
              <div
                id="qr-reader"
                className="
                  absolute
              ...
              <div
                className="
                  ...
                  inset-0
                  opacity-[0.07]
                  bg-[radial-gradient(circle_at_center,rgba(168,187,206,0.8)_0.16%,rgba(0,0,0,0)_0.16%)]
                "
              />
              ...
              <div
                className="
                  ...
                  -translate-x-1/2
                  rounded-full
                  bg-[radial-gradient(circle_at_center,rgba(168,187,206,0.12)_0%,rgba(168,187,206,0)_70%)]
                  opacity-40
                "
              />
